...
$adPublicIpAddress      = $adVMName + "-pip"
$adVmSize                   = "Basic_A1"
...
$clientPublicIpAddress      = $clientVMName + "-pip"
...
$serverPublicIpAddress      = $serverVMName + "-pip"
...
$linuxPublicIpAddress      = $linuxVMName + "-pip"
...
$MyParams = @{
  ...
  serverPublicIpAddress       = $serverPublicIpAddress
